...
class Conformer:	 
   ...
   def __init__(self, filename):
   	...
   	for index, line in enumerate(file):
   		if "FINAL HEAT OF FORMATION" in line: self.extractEnergy(line.rstrip('\n'))
...
for conf in listofconformers:
	if conf.diff < 22: print conf.filename + "   :   " + str(conf.lastscfenergy) + "   :   " + str(conf.ratio) + "   :   " + str(conf.diff)
